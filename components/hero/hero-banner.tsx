        ...
        <div className="relative bg-indigo-600 rounded-3xl p-8 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row justify-between gap-16">
            <div className="md:w-1/2 flex flex-col gap-16">
              <div className="">
                  <h1 className="text-4xl font-bold text-white mb-4 pt-5">Halo, Wiradarma</h1>
                  <p className="text-white text-xl ">
                    Dikit lagi kamu bisa <span className="font-semibold">Budaya Bali</span> nih! Ayo lanjutin progress
                    belajar kamu sekarang!
                  </p>
              </div>
              <div className="flex gap-4">
                <button className="px-6 py-2 bg-yellow-400 rounded-full font-medium">Lanjutin</button>
