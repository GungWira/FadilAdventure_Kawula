            ...
            <div className="h-56 p-8 flex items-center justify-between text-center bg-[#5956EB] rounded-lg">
                <div className="flex items-start flex-col gap-4">
                    ...
                    <h3 className="scroll-m-20 text-2xl text-muted font-semibold tracking-tight">
                        {/* nanti bisa tampilkan hint atau instruksi */}
                    </h3>
                </div>
                ...
                <div className="bg-white p-6 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" width={80} height={80} viewBox="0 0 24 24">
                        <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                              d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298zM16 9a5 5 0 0 1 0 6m3.364 3.364a9 9 0 0 0 0-12.728"></path>
                    </svg>
                </div>
            </div>
